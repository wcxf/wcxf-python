...
def _JMS_to_SUSY(C):
    ...
    d.update(_JMS_to_Bern_I(C, 'uc'))
    return d


def _SUSY_to_Flavio(C):
    d = {}
    d.update(_BernI_to_Flavio_I(_JMS_to_Bern_I(C, 'sb'), 'sb'))
    d.update(_BernI_to_Flavio_I(_JMS_to_Bern_I(C, 'db'), 'db'))
    d.update(_BernI_to_Flavio_I(_JMS_to_Bern_I(C, 'ds'), 'ds'))
    d.update(_BernI_to_Flavio_I(_JMS_to_Bern_I(C, 'uc'), 'uc'))
    return d

# Class II


def _JMS_to_Bern_CL2(C):
    d = {}
    d.update(_JMS_to_Bern_II(C,'udl_enu_e'))
    d.update(_JMS_to_Bern_II(C,'udl_enu_mu'))
    d.update(_JMS_to_Bern_II(C,'udl_enu_tau'))
    d.update(_JMS_to_Bern_II(C,'udl_munu_e'))
    d.update(_JMS_to_Bern_II(C,'udl_munu_mu'))
    d.update(_JMS_to_Bern_II(C,'udl_munu_tau'))
    d.update(_JMS_to_Bern_II(C,'udl_taunu_e'))
    d.update(_JMS_to_Bern_II(C,'udl_taunu_mu'))
    d.update(_JMS_to_Bern_II(C,'udl_taunu_tau'))
    d.update(_JMS_to_Bern_II(C,'usl_enu_e'))
    d.update(_JMS_to_Bern_II(C,'usl_enu_mu'))
    d.update(_JMS_to_Bern_II(C,'usl_enu_tau'))
    d.update(_JMS_to_Bern_II(C,'usl_munu_e'))
    d.update(_JMS_to_Bern_II(C,'usl_munu_mu'))
    d.update(_JMS_to_Bern_II(C,'usl_munu_tau'))
    d.update(_JMS_to_Bern_II(C,'usl_taunu_e'))
    d.update(_JMS_to_Bern_II(C,'usl_taunu_mu'))
    d.update(_JMS_to_Bern_II(C,'usl_taunu_tau'))
    d.update(_JMS_to_Bern_II(C,'ubl_enu_e'))
    d.update(_JMS_to_Bern_II(C,'ubl_enu_mu'))
    d.update(_JMS_to_Bern_II(C,'ubl_enu_tau'))
    d.update(_JMS_to_Bern_II(C,'ubl_munu_e'))
    d.update(_JMS_to_Bern_II(C,'ubl_munu_mu'))
    d.update(_JMS_to_Bern_II(C,'ubl_munu_tau'))
    d.update(_JMS_to_Bern_II(C,'ubl_taunu_e'))
    d.update(_JMS_to_Bern_II(C,'ubl_taunu_mu'))
    d.update(_JMS_to_Bern_II(C,'ubl_taunu_tau'))
    d.update(_JMS_to_Bern_II(C,'cdl_enu_e'))
    d.update(_JMS_to_Bern_II(C,'cdl_enu_mu'))
    d.update(_JMS_to_Bern_II(C,'cdl_enu_tau'))
    d.update(_JMS_to_Bern_II(C,'cdl_munu_e'))
    d.update(_JMS_to_Bern_II(C,'cdl_munu_mu'))
    d.update(_JMS_to_Bern_II(C,'cdl_munu_tau'))
    d.update(_JMS_to_Bern_II(C,'cdl_taunu_e'))
    d.update(_JMS_to_Bern_II(C,'cdl_taunu_mu'))
    d.update(_JMS_to_Bern_II(C,'cdl_taunu_tau'))
    d.update(_JMS_to_Bern_II(C,'csl_enu_e'))
    d.update(_JMS_to_Bern_II(C,'csl_enu_mu'))
    d.update(_JMS_to_Bern_II(C,'csl_enu_tau'))
    d.update(_JMS_to_Bern_II(C,'csl_munu_e'))
    d.update(_JMS_to_Bern_II(C,'csl_munu_mu'))
    d.update(_JMS_to_Bern_II(C,'csl_munu_tau'))
    d.update(_JMS_to_Bern_II(C,'csl_taunu_e'))
    d.update(_JMS_to_Bern_II(C,'csl_taunu_mu'))
    d.update(_JMS_to_Bern_II(C,'csl_taunu_tau'))
    d.update(_JMS_to_Bern_II(C,'cbl_enu_e'))
    d.update(_JMS_to_Bern_II(C,'cbl_enu_mu'))
    d.update(_JMS_to_Bern_II(C,'cbl_enu_tau'))
    d.update(_JMS_to_Bern_II(C,'cbl_munu_e'))
    d.update(_JMS_to_Bern_II(C,'cbl_munu_mu'))
    d.update(_JMS_to_Bern_II(C,'cbl_munu_tau'))
    d.update(_JMS_to_Bern_II(C,'cbl_taunu_e'))
    d.update(_JMS_to_Bern_II(C,'cbl_taunu_mu'))
    d.update(_JMS_to_Bern_II(C,'cbl_taunu_tau'))
    return d


def _Bern_to_ACFG(C):
    d = {}
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_enu_e')),'udl_enu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_enu_mu')),'udl_enu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_enu_tau')),'udl_enu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_munu_e')),'udl_munu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_munu_mu')),'udl_munu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_munu_tau')),'udl_munu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_taunu_e')),'udl_taunu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_taunu_mu')),'udl_taunu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'udl_taunu_tau')),'udl_taunu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_enu_e')),'usl_enu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_enu_mu')),'usl_enu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_enu_tau')),'usl_enu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_munu_e')),'usl_munu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_munu_mu')),'usl_munu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_munu_tau')),'usl_munu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_taunu_e')),'usl_taunu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_taunu_mu')),'usl_taunu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'usl_taunu_tau')),'usl_taunu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_enu_e')),'ubl_enu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_enu_mu')),'ubl_enu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_enu_tau')),'ubl_enu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_munu_e')),'ubl_munu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_munu_mu')),'ubl_munu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_munu_tau')),'ubl_munu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_taunu_e')),'ubl_taunu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_taunu_mu')),'ubl_taunu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'ubl_taunu_tau')),'ubl_taunu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_enu_e')),'cdl_enu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_enu_mu')),'cdl_enu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_enu_tau')),'cdl_enu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_munu_e')),'cdl_munu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_munu_mu')),'cdl_munu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_munu_tau')),'cdl_munu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_taunu_e')),'cdl_taunu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_taunu_mu')),'cdl_taunu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cdl_taunu_tau')),'cdl_taunu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_enu_e')),'csl_enu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_enu_mu')),'csl_enu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_enu_tau')),'csl_enu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_munu_e')),'csl_munu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_munu_mu')),'csl_munu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_munu_tau')),'csl_munu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_taunu_e')),'csl_taunu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_taunu_mu')),'csl_taunu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'csl_taunu_tau')),'csl_taunu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_enu_e')),'cbl_enu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_enu_mu')),'cbl_enu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_enu_tau')),'cbl_enu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_munu_e')),'cbl_munu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_munu_mu')),'cbl_munu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_munu_tau')),'cbl_munu_tau')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_taunu_e')),'cbl_taunu_e')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_taunu_mu')),'cbl_taunu_mu')
    d.update(_BernII_to_ACFG(_JMS_to_Bern_II(C,'cbl_taunu_tau')),'cbl_taunu_tau')
    return d


def _Bern_to_Flavio_CL2(C):
    d = {}
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_enu_e')),'udl_enu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_enu_mu')),'udl_enu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_enu_tau')),'udl_enu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_munu_e')),'udl_munu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_munu_mu')),'udl_munu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_munu_tau')),'udl_munu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_taunu_e')),'udl_taunu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_taunu_mu')),'udl_taunu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'udl_taunu_tau')),'udl_taunu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_enu_e')),'usl_enu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_enu_mu')),'usl_enu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_enu_tau')),'usl_enu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_munu_e')),'usl_munu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_munu_mu')),'usl_munu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_munu_tau')),'usl_munu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_taunu_e')),'usl_taunu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_taunu_mu')),'usl_taunu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'usl_taunu_tau')),'usl_taunu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_enu_e')),'ubl_enu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_enu_mu')),'ubl_enu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_enu_tau')),'ubl_enu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_munu_e')),'ubl_munu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_munu_mu')),'ubl_munu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_munu_tau')),'ubl_munu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_taunu_e')),'ubl_taunu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_taunu_mu')),'ubl_taunu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'ubl_taunu_tau')),'ubl_taunu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_enu_e')),'cdl_enu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_enu_mu')),'cdl_enu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_enu_tau')),'cdl_enu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_munu_e')),'cdl_munu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_munu_mu')),'cdl_munu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_munu_tau')),'cdl_munu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_taunu_e')),'cdl_taunu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_taunu_mu')),'cdl_taunu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cdl_taunu_tau')),'cdl_taunu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_enu_e')),'csl_enu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_enu_mu')),'csl_enu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_enu_tau')),'csl_enu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_munu_e')),'csl_munu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_munu_mu')),'csl_munu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_munu_tau')),'csl_munu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_taunu_e')),'csl_taunu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_taunu_mu')),'csl_taunu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'csl_taunu_tau')),'csl_taunu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_enu_e')),'cbl_enu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_enu_mu')),'cbl_enu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_enu_tau')),'cbl_enu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_munu_e')),'cbl_munu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_munu_mu')),'cbl_munu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_munu_tau')),'cbl_munu_tau')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_taunu_e')),'cbl_taunu_e')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_taunu_mu')),'cbl_taunu_mu')
    d.update(_BernII_to_FlavioII(_JMS_to_Bern_II(C,'cbl_taunu_tau')),'cbl_taunu_tau')
    return d
